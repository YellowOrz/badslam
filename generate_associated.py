...
data_dir = "/home/orz/Projects/Datasets/FastFusion/dorm2/dorm2_medium"
depth_name = "filtered"
color_name = "color"
...
with open(log_path, 'w') as f:
    if not os.path.exists(timestamp_path):
        ...
        for i, (depth_path, color_path) in enumerate(zip(depth_paths, color_paths)):
            ...
            f.write("{} {}/{} {} {}/{}\n".format(idx, color_name, color_filename, idx, depth_name, depth_filename))
            idx += 1
